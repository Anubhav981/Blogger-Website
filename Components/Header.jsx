  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      <div className='flex justify-between items-center'>
        ...
        <a href="http://localhost:3000/admin" className="inline-block">
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Discover insightful blogs on a variety of topics, from lifestyle and tech to travel and wellness. Dive in to explore ideas, stories, and tips that inspire and inform.</p>
